...
2.  **Intelligence Engine**: Ollama (Llama 3 / Mistral) for generating captions, comments, and personality.
...
- [Setup Models (Flux.1)](docs/setup_models.md)

### Usage (Current)
Currently, only the Visual Engine is active.
```bash
